import { Box, Button, Divider, Flex, Image, Img, Input, Text } from "@chakra-ui/react";
import "./home.scss";
...
const Home = () => {
  return (
    <Box marginRight={"8rem"} marginLeft={"8rem"} mt={"2rem"} p={4}>
      <Flex justifyContent="space-between" h="100%">
        ...
        <Flex px={4} w={"100%"} alignItems={"center"} direction={"column"}>
          ...
          >
            ...
            <Divider mt={"5px"} />
            <Flex alignItems={"center"}  justifyContent="space-evenly" fontSize={"20px"} mt={"10px"}>
              <Flex alignItems={"center"} gap={"10px"}><GrLike />Like</Flex>
              <Flex alignItems={"center"} gap={"10px"}><FaRegComment />Comment</Flex>
              <Flex alignItems={"center"} gap={"10px"}><PiShareFatLight />Share</Flex>
              <Flex alignItems={"center"} gap={"10px"}><BsFillSaveFill />Save</Flex>
            </Flex>
            <Flex
            alignItems={"center"}
            bg={"gray.dark"}
